      ...
      return (
          ...
          <div className="App">
              <div className="App-header" >
                  ...
                  <h2 style={{ display: 'inline-block' }}>SurveyJS and EMail editor</h2>
              </div>

          <Tabs>
              <TabList>
                  <Tab><h2>Survey</h2></Tab>
                  <Tab><h2>Mail template</h2></Tab>
              </TabList>
              ...
              <TabPanel>
                ...
                <div className="surveyjs">
                  ...
                  <h4>SurveyJS library in action:</h4>
                  <Survey.Survey
                    model={model}
                  ...
                  <h4>SurveyJS Creator in action:</h4>
                  <SurveyCreator />
                </div>
